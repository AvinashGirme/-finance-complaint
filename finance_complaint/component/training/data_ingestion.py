...
class DataIngestion:
    ...
    def download_data(self,download_url:DownloadUrl):
        try:
            ...
            #downloading data
            requests.get(download_url.url,params={'User-agent':f'your bot {uuid.uuid4()}'})
    ...
    def retry_download_data(self,data,download_url:DownloadUrl):
        ...
        try:
            ...
            if download_url.n_retry == 0:
                ...
                return
            #to handle throatling requestion and can be solve if we wait for some seconds
            ...
            #calling download function againt to retry
    ...
    def write_metadata(self,file_path: str) -> None:
        ...
        try:
            logger.info(f"writing metadata into metadata file.")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            if os.path.exists(self.data_ingestion_config.download_dir):
                logger.info(f"Converting and combining downloaded json ito parquet file")
            ...
            artifact =DataIngestionArtifact(
                ...
                metadata_file_path=data_ingestion_config.metadata_file_path,
                 download_dir=data_ingestion_config.download_dir)
