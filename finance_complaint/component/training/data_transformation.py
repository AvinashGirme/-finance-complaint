...
class DataTransformation():
    ...
    def read_data() -> DataFrame:
        try:
            self.data_val_artifact.accepted_file_path
    ...
    def get_data_transformation_pipeline(self,) -> Pipeline:
        try:
            ...
            # creating the imputer to fill null values
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logger.info(f"Number of row: [{dataframe.count()}] and columm : [{len(dataframe.columns)}]")
            ...
            data_tf_artifact = DataTransformationArtifact(
                ...
                exported_pipeline_file_path=transformed_test_data_file_path,
                 transformed_test_file_path=export_pipeline_file_path,
                 )
