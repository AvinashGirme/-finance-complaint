...
class CloudEstimator(ABC):
    ...
    def get_latest_model_path(self,key) -> str:
        ...
        Args:
        key:
        Returns:Complete key path of cloud storafe to download model
        """
        pass
    @abstractmethod
    def decompress_model(self,zip_model_file_path,extract_dir):
        ...
        Args: 
        zip_model_file_path: zipped_model_file_location
    ...
    def compress_model_dir(self,model_dir):
        """ 
        This function help us to zip model so that model can be uploaded to 
        cloud storage such as s3 bucket, azure blob storage,google cloud storage
    ...
    def transform(self,df) ->DataFrame:
        """ 
        This function is designed to ne overridden by child class
        Args:
        df:Inout dataframe
        Returns:
