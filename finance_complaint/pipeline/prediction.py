...
class PredictionPipeline:
    def __init__(self,pipeline_config=PredictionPipelineConfig()) -> None:
        ...
        self.s3_storage:SimpleStorageService = SimpleStorageService(region_name=pipeline_config.region_name
                                                    , s3_bucket_name=S3_DATA_BUCKET_NAME)
    ...
    def start_batch_prediction(self):
        try:
            ...
            for valid_file in valid_files:
                logger.info("Starting prediction of file :{valid_file}")
                ...
                logger.info(f"Saving required columns: {required_columns}")
                ...
                logger.info(f"Writting prediction file at : [{self.pipeline_config.prediction_dir}]")
                ...
                logger.info(f"Archiving valid input files at: [{archive_file_path}]")
