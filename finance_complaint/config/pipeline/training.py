...
from finance_complaint.entity.config_entity import DataIngestionConfig,TrainingPipelineConfig,DataValidationConfig,\
    ModelTrainerConfig,DataTransformationConfig,ModelEvaluationConfig,ModelPusherConfig
...
class FinanceConfig:
    ...
    def get_pipeline_config(self) -> TrainingPipelineConfig:
        ...
        return > PipelineConfig =namedtuple("PipelineConfig",["pipeline_name","artifact_dir"]) 
        """
        try:
    ...
    def get_data_ingestion_config(self,from_date=DATA_INGESTION_MIN_START_DATE,
        ...
        metadata_file_path=os.path.join(data_ingestion_master_dir,
    ...
    def get_data_transformation_config(self) ->DataTransformationConfig:
        try:
            ...
            transformed_train_data_dir=os.path.join(data_transformation_dir,
